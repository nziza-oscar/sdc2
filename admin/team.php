...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add'])) {
    ...
    if ($count >= 5) {
        $_SESSION['error'] = "Maximum 5 team members reached. Please delete an existing member first.";
        ...
        if ($stmt->execute()) {
            ...
            $_SESSION['error'] = "Error adding team member.";
            header('Location: team.php');
            exit;
        }
    }
                        ...
                        <template x-if="!previewImage && editingId">
                            <div class="mb-4">
                                <img :src="getImageUrl(team.find(m => m.id === editingId)?.image)" 
                                     ...
                                     @error="$event.target.src='https://via.placeholder.com/400x400?text=No+Photo'">
                            </div>
                        </template>
                ...
                <div class="md:col-span-2 space-y-4">
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1" x-show="!validateLinkedin(formData.linkedin) && formData.linkedin" x-cloak class="text-red-500">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1" x-show="!validateEmail(formData.email) && formData.email" x-cloak class="text-red-500">
                                Enter a valid email
                            </p>
                        </div>
                    </div>
                ...
                <div class="relative h-64 bg-gray-100">
                    ...
                    <div class="absolute bottom-3 right-3 flex gap-2">
                        ...
                        <a x-show="member.email" :href="'mailto:' + member.email"
                           class="w-8 h-8 bg-white rounded-full flex items-center justify-center text-gray-600 hover:bg-gray-600 hover:text-white transition-colors shadow-md">
